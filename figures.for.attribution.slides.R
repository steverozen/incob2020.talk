# This is strictly "as-is" code for figures showing:
#
# 1. attribution using all signatures
#
# 2. the above, but with signatures filtered for a minimum number of
...
#    by selection according to maximum a posteriori probability
#
# Copyright 2020 Steven G Rozen
#
# License: GPL3
...
# 2. Only attribute with signatures that made large contributions
#    in step 1, above
